...
from comp0037_planner_controller.a_star_sq_euclidean import AStarSqEuclideanPlanner
...
planner = AStarSqEuclideanPlanner('A Star Euclidean Search', occupancyGrid)
